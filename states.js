   ...
   .config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$sceDelegateProvider', function ($stateProvider, $urlRouterProvider, $locationProvider, $sceDelegateProvider) {
      ...
      $stateProvider
         .state("contents", {
            ...
            views: {
               'left': {
                   template: '<div class="sidebar-left-content" ng-include="\'/navigation/views/navbaritem.html\'" ng-repeat="item in itemsList track by $index"></div>',
          ...
          .state('profile', {
            ...
            views: {
               'left': {
                ...
                'breadcrumbs': {
                   templateUrl: '/groupAdmin/breadcrumbs.html',
