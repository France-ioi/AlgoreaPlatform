...
$tablesModels = array (
   ...
   "items" => array(
      ...
      "fields" => array(
         ...
         "sOptions" => array("type" => "string", "access" => array("write" => array("user"), "read" => array("user"))),
         "sRepositoryPath" => array("type" => "string", "access" => array("write" => array("user"), "read" => array("user"))),
         "sType" => array("type" => "string", "access" => array("write" => array("user"), "read" => array("user"))),
   ...
   "groups_attempts" => array(
      ...
      "fields" => array(
          ...
          "sBestAnswerDate"  => array("type" => "date", "access" => array("write" => array("user"), "read" => array("user")), 'readOnly' => true),
...
$viewsModels = array(
   ...
   "groups_attempts" => array(
      ...
      "fields" => array(
          ...
          "sBestAnswerDate"       => array('readOnly' => true),
