...
$viewsModels = array(
   "filters" => array(
      ...
      "adminOnly" => false,
      "joins" => array(
         "groups" => array("type" => "LEFT", "dstField" => "ID", "srcField" => "idGroup", "srcTable" => "filters", "dstTable" => "groups"),
         "items_strings" => array("type" => "LEFT", "dstField" => "idItem", "srcField" => "idGroup", "srcTable" => "filters", "dstTable" => "items_strings"),
      ),
      "fields" => array(
         "idUser" => array(),
         "sName" => array(),
         ...
         "sBodySearch" => array(),
         "bImportant" => array(),
         "sGroupName" => array('joins' => 'groupsLeft', 'tableName' => 'groups', 'fieldName' => 'sName', 'readOnly' => true),
         "sItemTitle" => array('joins' => 'groupsLeft', 'tableName' => 'groups', 'fieldName' => 'sName', 'readOnly' => true),
      ),
      "filters" => array(
         "accessible" => array(
   ...
   "items" => array(
      ...
      "filters" => array(
         ...
         "idItemAncestor" => array(
            ...
            "condition" => '`[PREFIX]items_ancestors`.`idItemAncestor` = :[PREFIX_FIELD]idItemAncestor'
         ),
         "idItem" => array(
            "joins" => array(),
   ...
   "items_strings" => array(
      ...
      "joins" => array(
         ...
         "threads" => array("srcTable" => "items_strings", "srcField" => "idItem", "dstField" => "idItem"),
      ),
      "fields" => array(
         "idItem"          => array(),
         "idLanguage"      => array(),
   ...
   "threads" => array(
      ...
      "joins" => array(
         ...
         "items_strings" => array("srcTable" => "threads", "dstTable" => "items_strings", "srcField" => "idItem", "dstField" => "idItem"),
      ),
      "fields" => array(
          "sType"             => array(),
      ...
      "filters" => array(
         ...
         "generalRead" => array(
            "condition"  => "(`[PREFIX]threads`.`sType` = 'General' or `[PREFIX]threads`.`sType` = 'Bug')",
            "ignoreValue" => true
         ),
         "mine" => array(
   ...
   "users_items" => array(
      ...
      "joins" => array(
         ...
         "items_items" => array("srcTable" => "users_items", "srcField" => "idItem", "dstField" => "idItemChild"),
      ),
      "fields" => array(
